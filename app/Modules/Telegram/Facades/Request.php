 ...
 * @method static SendMessageDTO sendPhoto(int $chat_id, UploadedFile|string $photo, string|null $caption, ?string $parse_mode = 'html', ?array $caption_entities = null, ?string $reply_markup = null, array $reply_parameters = [])
 * @method static SendMessageDTO editMessageText(int $chat_id, int $message_id, string $text, string $parse_mode = 'html', ?string $reply_markup = null)
